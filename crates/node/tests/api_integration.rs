...
async fn make_test_state() -> AppState {
    ...
    AppState {
        ...
        api_key: None,
        api_key_registry: Arc::new(msearchdb_core::security::ApiKeyRegistry::new()),
        jwt_manager: None,
        rate_limiter: Arc::new(msearchdb_core::security::RateLimiter::new(100, 10.0)),
        connection_counter: Arc::new(msearchdb_core::security::ConnectionCounter::new(1000)),
        validation_config: Arc::new(msearchdb_core::security::ValidationConfig::default()),
        audit_logger: Arc::new(msearchdb_core::security::AuditLogger::noop()),
        security_config: Arc::new(msearchdb_core::security::SecurityConfig::default()),
